        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (Environment.MEDIA_MOUNTED.equals(state)) {
                    totalSize = StorageUtil.getTotalSize(path);
                    availaleSize = StorageUtil.getAvailableSize(path);
                }
                final String msg = "path==" + path
                        + " ,removable==" + removable
                        + ",state==" + state
                        + ",total size==" + totalSize + "(" + StorageUtil.fmtSpace(totalSize) + ")"
                        + ",availale size==" + availaleSize + "(" + StorageUtil.fmtSpace(availaleSize) + ")";
                Log.e(TAG, msg);
